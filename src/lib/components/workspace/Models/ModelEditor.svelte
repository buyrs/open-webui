<script lang="ts">
	...
	let info = {
		...
		name: '',
		meta: {
			profile_image_url: `${WEBUI_BASE_URL}/static/boutikio-logo.svg`,
			description: '',
						...
						<div class="self-start flex justify-center my-2 shrink-0">
							<div class="self-center">
								<button
									...
									`${WEBUI_BASE_URL}/static/boutikio-logo.svg`
										? 'bg-transparent'
								...
								<div class="flex w-full mt-1 justify-end">
									<button
										...
										on:click={() => {
											info.meta.profile_image_url = `${WEBUI_BASE_URL}/static/boutikio-logo.svg`;
										}}
										type="button"
									>
